...
-- 1-day expiring access keys for the Foreigner page generated by Telegram bot admins.
CREATE TABLE IF NOT EXISTS theziess_foreigner_keys_v1 (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS theziess_foreigner_keys_v1_code_idx
  ON theziess_foreigner_keys_v1(key_code, is_revoked, expires_at DESC);
